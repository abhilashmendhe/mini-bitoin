use mini_bitoin::crypto::{crypto_utils::{base58, to_32bytes_vec_big_endian}, private_key::PrivateKey, s256_point::S256Point, signature::Signature};
...
fn base58_test() {
    ...
    let b_hex_decode = hex::decode("eff69ef2b1bd93a66ed5219add4fb51e11a840f404876325a1e8ffe0529a2c").unwrap();
    ...
    assert!(base58(&b_hex_decode)=="4fE3H2E6XMp4SsxtwinF7w9a34ooUrwWe4WsW1458Pd".to_string());
