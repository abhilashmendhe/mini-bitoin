use mini_bitoin::{
    elliptic_curve::ecc_point::Point, finite_fields::field_element::FieldElement,
    utils::errors::BTCErr,
};
...
fn point_add_field_elem_test() {
    ...
    let p3 = Point::new(
        FieldElement::new((170).into(), prime.clone()),
        FieldElement::new((142).into(), prime.clone()),
        a.clone(),
        b.clone(),
    );
    ...
    let p2 = Point::new(x2, y2, a.clone(), b.clone());
    let p3 = Point::new(
        FieldElement::new((220).into(), prime.clone()),
        FieldElement::new((181).into(), prime.clone()),
        a.clone(),
        b.clone(),
    );
    println!("p1 + p2 = {}", p1.clone() + p2.clone());
    ...
    let p2 = Point::new(x2, y2, a.clone(), b.clone());
    let p3 = Point::new(
        FieldElement::new((215).into(), prime.clone()),
        FieldElement::new((68).into(), prime.clone()),
        a.clone(),
        b.clone(),
    );
    println!("p1 + p2 = {}", p1.clone() + p2.clone());
    ...
    let p2 = Point::new(x2, y2, a.clone(), b.clone());
    let p3 = Point::new(
        FieldElement::new((47).into(), prime.clone()),
        FieldElement::new((71).into(), prime.clone()),
        a.clone(),
        b.clone(),
    );
    println!("p1 + p2 = {}", p1.clone() + p2.clone());
